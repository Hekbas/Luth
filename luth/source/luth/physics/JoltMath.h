...
{
    // GLM and Jolt share Mat4/Mat44 column-major layout and Quat (x,y,z,w) storage, so matrix and quaternion
    ...
    // Pair these with LuthMath.h's GLM-side asserts to confirm both ends of the conversion. JPH::Vec3 is
    // intentionally larger than its GLM peer.
