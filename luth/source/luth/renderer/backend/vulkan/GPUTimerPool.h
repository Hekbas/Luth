...
namespace Luth
{
    /// Manages per-frame VkQueryPools for GPU timestamp profiling.
    /// Results are read with a 2-frame latency (GPU N-2 is guaranteed complete).
    class GPUTimerPool
    {
    public:
        ...
        /// Write a timestamp before (isBegin=true) or after (isBegin=false) a pass.
        /// passIndex is a 0-based counter of non-culled passes in this frame.
