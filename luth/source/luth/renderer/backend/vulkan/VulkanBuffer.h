...
namespace Luth
{
    ...
    public:
        ...
        // Timeline value UploadContext signals when this buffer's most recent upload retires; consumers poll
        // UploadContext::IsComplete to gate rendering + the deferred BLAS build (never a blocking wait).
