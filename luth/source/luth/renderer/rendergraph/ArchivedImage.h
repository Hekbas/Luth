...
namespace Luth::RG
{
    ...
    struct ArchivedImage
    {
        ...
        // Lazy single-layer image view, used to slice into a cascade or array layer for the
        // panel UI. Returns VK_NULL_HANDLE if `layer` is out of range. Cached into layerViews
        // so repeated calls don't churn descriptors.
