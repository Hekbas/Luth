...
namespace Luth
{
    ...
    private:
        ...
        // 3D Worley-FBM noise (128^3 RGBA8). Single shared instance, baked once at Init; modulates
        ...
        // 2D blue-noise dither (Roberts R2 quasi-random, 64^2 R8). Composite jitters sliceW +/-0.5
