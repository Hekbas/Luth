...
An editor architecture review series (`editor-cleanup` v2.7.0, `editor-style-assets` v2.7.1, `editor-widgets-reorg` v2.7.2 shipped; follow-ups queued: `editor-undo-gaps`, `editor-component-registry`, `editor-scene-panel-slim`) will interleave with the feature epics above as patch-minor bumps.
