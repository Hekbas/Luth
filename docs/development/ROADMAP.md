...
|----------|------|-------|--------|-----------|------|
| 1 | `play-mode` | [#66](https://github.com/Hekbas/Luth/issues/66) | v2.8.0 | 1-2 weeks | — |
| 2 | `jolt-physics` | [#56](https://github.com/Hekbas/Luth/issues/56) | v2.9.0 | 2-3 weeks | `play-mode` |
| 3 | `jiggle-bones` | [#61](https://github.com/Hekbas/Luth/issues/61) | v2.9.1 | 1 week | — |
| 4 | `forward-plus` | [#54](https://github.com/Hekbas/Luth/issues/54) | v2.10.0 | 2 weeks | `compute-gpu-culling` |
| 5 | `fxaa-taa` | [#72](https://github.com/Hekbas/Luth/issues/72) | v2.10.1 | 1 week | — |
| 6 | `gpu-particles` | [#57](https://github.com/Hekbas/Luth/issues/57) | v2.11.0 | 2-3 weeks | `compute-gpu-culling`, `forward-plus` |

An editor architecture review series (`editor-cleanup` v2.7.0, `editor-style-assets` v2.7.1, `editor-widgets-reorg` v2.7.2, `editor-undo-gaps` v2.7.3 shipped; follow-ups queued: `editor-component-registry`, `editor-scene-panel-slim`) will interleave with the feature epics above as patch-minor bumps.
