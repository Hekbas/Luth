...
An editor architecture review series (`editor-cleanup` shipped in v2.7.0; follow-ups queued: `editor-style-assets`, `editor-widgets-reorg`, `editor-undo-gaps`, `editor-component-registry`, `editor-scene-panel-slim`) will interleave with the feature epics above as patch-minor bumps.
